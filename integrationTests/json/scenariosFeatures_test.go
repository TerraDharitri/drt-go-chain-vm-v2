...
func TestRustComposability(t *testing.T) {
	...
	runTestsInFolder(t, "features/composability/scenarios", []string{
		"features/composability/scenarios/recursive_caller_rewa_2.scen.json",
		"features/composability/scenarios/recursive_caller_dcdt_2.scen.json",
		"features/composability/scenarios/recursive_caller_dcdt_x.scen.json",
	})
}
